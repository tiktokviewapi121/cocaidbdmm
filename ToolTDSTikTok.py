...
hong = "\033[1;95m"
# Đánh dấu bản quyền
d-tool= "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  "
liggdzut= "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  "
##### Cài Thư Viện #####
...
\033[97m════════════════════════════════════════════════  
\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m Tool\033[1;31m     : \033[1;97m☞ \033[1;31mTDS - TikTok\033[1;33m♔ \033[1;97m🔫
...
def main():
	...
	while True:
		if os.path.exists('configtds.txt'):
			...
			data = tds.main()
			try:
				print(f'{liggdzut}{luc}Nhập {vang}[{trang}1{vang}] {luc}Giữ Lại Tài Khoản '+vang+ data['user'] )
				print(f'{liggdzut}{luc}Nhập {vang}[{trang}2{vang}] {luc}Nhập Access_Token TDS Mới')
				chon = input(f'{liggdzut}{luc}Nhập {trang}===>: {vang}')
				if chon == '2':
		...
		if not os.path.exists('configtds.txt'):
			token = input(f'{liggdzut}{luc}Nhập Access_Token TDS: {vang}')
...
#while True:
	...
	banner()
	print(f'{liggdzut}{luc}Tên Tài Khoản: {vang}{user} ')
	print(f'{liggdzut}{luc}Xu Hiện Tại: {vang}{xu}')
	print(f'{liggdzut}{luc}Xu Bị Phạt: {vang}{xudie} ')
	while True:
		ntool=0
		bongoc(14)
		print(f'{liggdzut}{luc}Nhập {red}[{vang}1{red}] {luc}Để Chạy Nhiệm Vụ Tim')
		print(f'{liggdzut}{luc}Nhập {red}[{vang}2{red}] {luc}Để Chạy Nhiệm Vụ Follow')
		print(f'{liggdzut}{luc}Nhập {red}[{vang}3{red}] {luc}Để Chạy Nhiệm Vụ Follow Tiktok Now')
		nhiem_vu=input(f'{liggdzut}{luc}Nhập Số Để Chạy Nhiệm Vụ: {vang}')
		dl = int(input(f'{liggdzut}{luc}Nhập Delay: {vang}'))
		while True:
			if ntool == 2:
				break
			ntool = 0
			bongoc(14)
			nv_nhan=int(input(f'{liggdzut}{luc}Sau Bao Nhiêu Nhiệm Vụ Thì Nhận Xu: {vang}'))
			if nv_nhan < 8:
			...
			if nv_nhan > 15:
				...
				continue
			user_cau_hinh=input(f'{liggdzut}{luc}Nhập User Name Tik Tok Cần Cấu Hình: {vang}')
								...
								if cache != True:
									...
									if dem % nv_nhan == 0:
										...
										if nhan == 0:
											...
											print(f'{liggdzut}{luc}Nhập {red}[{vang}1{red}] {luc}Để Thay Nhiệm Vụ ')
											print(f'{liggdzut}{luc}Nhập {red}[{vang}2{red}] {luc}Thay Acc Tiktok ')
											print(f'{liggdzut}{luc}Nhấn {red}[{vang}Enter{red}] {luc}Để Tiếp Tục')
											chon=input(f'{liggdzut}{luc}Nhập {trang}===>: {vang}')
											if chon == '1':
												ntool=2
												break
