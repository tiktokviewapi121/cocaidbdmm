import requests, json, base64, os, sys, uuid, re, time,  json
...
def Main():
    ...
    if os.path.exists('settingch.json'):
        ...
        doinick = config['doinick']
        nhiemvuloi = config['nhiemvuloi']
    chonan = input(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mBạn Có Muốn Ẩn Id Facebook Không {red}({vang}y/n{red}){trang}: {vang}')
    print (Colorate.Diagonal(Colors.blue_to_green, "══════════════════════════════════════════════════════════════"))
    while True:
        if len(listck) == 0:
                ...
                if '4' in nhiemvu:
                    ...
                    if listfl == False:
                        ...
                        if listfl['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            ...
                            print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mĐang Get Nhiệm Vụ {vang}Follow, {luc}COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(0); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                    ...
                    if listpage == False:
                        ...
                        if len(list_nv) == 0:
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32m Không Thành Công | LikePage : {id}            ", end = '\r'); sleep(0); print('                                                       ', end = '\r')
                                    Delay(0)
                                    loipage+=1
                                else:
